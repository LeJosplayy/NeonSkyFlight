...
namespace MultiWiiWinGUI
{
    ...
    {
        String NeonSkyFlightWindowsUIVersion;
        String NeonSkyFlightWindowsUIDlLink;
        ...
        string[] sNavError = { "Navigation system is OK",
        ...
        string[] sRefreshSpeeds = { "MAX", "60 Hz", "10 Hz", "5 Hz", "2 Hz", "1 Hz" };
        int[] iRefreshIntervals = { 10, 20, 50, 100, 600, 1500 };
        ...
        public mainGUI()
        {
            ...
            mapProviders[4] = GMapProviders.OpenStreetMap;
        ...
        private void mainGUI_Load(object sender, EventArgs e)
        {
            ...
            splash.colorProgressBar1.Value = 0;
            splash.Update();
            ...
            splash.l_version.Visible = true;
            splash.colorProgressBar1.Visible = true;
            ...
            splash.colorProgressBar1.Value = 20;
            splash.Update();
            ...
            splash.colorProgressBar1.Value = 30;
            splash.Update();
            ...
            splash.colorProgressBar1.Value = 40;
            splash.Update();
            ...
            else
            {
                ...
                {
                  //  splash.Update();
                  //  MessageBox.Show("Update available \n\nThis Version : " + Assembly.GetExecutingAssembly().GetName().Version.ToString().Replace(".", "") + "\nNew Version: " + NeonSkyFlightWindowsUIVersion, "Update available", MessageBoxButtons.OK, MessageBoxIcon.Information);
            ...
            splash.colorProgressBar1.Value = 50;
            splash.Update();
            ...
            splash.colorProgressBar1.Value = 60;
            splash.Update();
            ...
            splash.colorProgressBar1.Value = 70;
            splash.Update();
            ...
            splash.colorProgressBar1.Value = 80;
            splash.Update();
            ...
            splash.colorProgressBar1.Value = 90;
            splash.Update();
            ...
            splash.colorProgressBar1.Value = 100;
            splash.Update();
        ...
        private void update_gui()
        {
            ...
            if (isConnected)
            {
                this.Text = "NeonSkyFlight [" + serialPort.PortName + "@" + serialPort.BaudRate + "]   [GPS Sat : " + mw_gui.GPS_numSat + "]  [GPS Alt : " + mw_gui.GPS_altitude + "]  [GPS Speed : " + mw_gui.GPS_speed + "]";
            }
            //Common stuff
        ...
        private void cbGUISpeechEnabled_CheckedChanged_1(object sender, EventArgs e)
        {

        }

        private void cbAutoPan_CheckedChanged(object sender, EventArgs e)
        {
        ...
        {
            System.Diagnostics.Process.Start("https://github.com/LeJosplayy/NeonSkyFlight");
        }
        bool CheckUpdate()
        /////////////////////////////////////////Uptater///////////////////////////////////////////
        {
            try
            {
                var url = "https://lejosplayy.github.io/NeonSkyUpdater/ThisVersion.html";
                ...
                NeonSkyFlightWindowsUIVersion = reader.ReadLine().Replace("NeonSkyFlightWindowsUIVersion:", "");
                NeonSkyFlightWindowsUIDlLink = reader.ReadLine().Replace("NeonSkyFlightWindowsUIDlLink:", "");

                int ThisVersion = int.Parse(Assembly.GetExecutingAssembly().GetName().Version.ToString().Replace(".", ""));

                if (int.Parse(NeonSkyFlightWindowsUIVersion) > ThisVersion)
                {
                    return true;
                }
                else
        ...
        private void AP_Selector_SelectedIndexChanged(object sender, EventArgs e)
        {
        ...
        {
            pictureBox2.Image = Properties.Resources.Master_Warning_ON;
            pictureBox2.Update();
            Thread.Sleep(400);
            pictureBox2.Image = Properties.Resources.Master_Warning_OFF;

        }

        private void pictureBox3_Click(object sender, EventArgs e)
        {
            pictureBox3.Image = Properties.Resources.Master_Caution_ON;
            pictureBox3.Update();
            Thread.Sleep(400);
            pictureBox3.Image = Properties.Resources.Master_Caution_OFF;
        }
        ...
        public static void UpdateSyswarnings()
        {
