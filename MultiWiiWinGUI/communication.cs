    ...
    public partial class mainGUI : Form
    {
        ...
        private void b_connect_Click(object sender, EventArgs e)
        {
            ...
            else                               //Connect
            {
                ...
                load.colorProgressBar1.Value = 20;
                load.Update();
                try
                {
                    serialPort.Open();
                    load.colorProgressBar1.Value = 30;
                    load.Update();
                ...
                if (tries == 10) { failed_connect_cleanup(1);
                ...
                load.colorProgressBar1.Value = 40;
                load.Update();
                serial_packet_rx_count = 0;
                serial_packet_tx_count = 0;
                ...
                if (check_capability(CAP.NAV_CAPABLE))
                {
                    ...
                    {
                        load.colorProgressBar1.Value = 50;
                        load.Update();
                ...
                load.colorProgressBar1.Value = 60;
                load.Update();
                ...
                update_gui();
                load.colorProgressBar1.Value = 80;
                load.Update();
                load.colorProgressBar1.Value = 100;
                load.colorProgressBar1.BarColor= Color.LightGreen;
                load.Update();
                load.Hide();
            }
        }
